...
class RExDiscordAddCommand(commands.Cog):
    ...
    async def add_cave(self, ctx: commands.Context, cave_id: str, ore_id: str, cave_name: str, world_id: str,
                       cave_rarity: int):
    ...
    async def add_layer(self, ctx: commands.Context, layer_id: str, ore_id: str, layer_name: str, world_id: str,
    ...
    async def add_tier(self, ctx: commands.Context, tier_id: str, tier_name: str, tier_num: int, min_rarity: int,
                       max_rarity: int):
    ...
    @app_commands.autocomplete(
        tier_id=get_items(RExTierManager().get_all(), lambda x: x.tier_id, lambda x: x.tier_name))
    @app_commands.describe(
    ...
    async def add_spawn(self, ctx: commands.Context, ore_id: str, layer_id: typing.Optional[str],
                        cave_id: typing.Optional[str], rarity: int):
    ...
    async def add_equipment(self, ctx: commands.Context, equip_id: str, equip_name: str, equip_desc, equip_tier: int,
                            equip_type: RExEquipmentType, world_id: typing.Optional[str]):
    ...
    async def add_ability(self, ctx: commands.Context, ability_id: str, equip_id: str, ability_name: str,
                          ability_desc: str, ability_rate: int, ability_luck: typing.Optional[str],
                          ability_lifespan: typing.Optional[str], ability_area: typing.Optional[str],
                          ability_amount: typing.Optional[str], ability_pinned_luck: typing.Optional[str]):
    ...
    async def add_event(self, ctx: commands.Context, ore_id: str, world_id: str, event_text: str, event_desc: str,
                        ore_rarity: int, event_duration: int, event_chance: int):
